...
const AdminEditProduct = (
    ...
    const HandleUploadProduct = async(e) => {
        ...
        const HandleSubmit = async (e) => {
            ...
            console.log("SummaryApi.updateProduct.url",SummaryApi.updateProduct.url)
    ...
    <div className='bg-white p-4 rounded w-full max-w-2xl h-full max-h-[80%] overflow-hidden'>    
        ...
        <form className='grid gap-3 p-4 overflow-y-scroll h-full pb-5' onSubmit={HandleSubmit}>
            ...
            <label htmlFor="productImage" className='mt-3'>Product Image : </label>
                ...
                <button className='px-3 py-2  bg-red-600 text-white mb-6 hover:bg-red-700'>Update Product</button>
        </form>
    </div>
